...
string1: 	.asciiz 	"O inverso multiplicativo eh "		# string para mostrar o resultado da opera√ß√£o
...
calc_inverso:
	...
	mfhi $t8			# t8 recebe o modulo da divis„o entre t7 e s0
...
imprime_saida:
	...
	li $v0, 1			# prepara v0 para a funÁ„o de print integer
	syscall				# executa o print
	j end
